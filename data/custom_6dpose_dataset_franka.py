...
class IN2POSEDATASET(Dataset):
    ...
    def __init__(self, root='/data/ML_document/datasets/franka_panda_sample_data', ann_file='json_info_3501_with_cam_0217.xlsx', transform=transforms.ToTensor(), target_transform=None):        
